...
func TestInt(t *testing.T) {
	...
	Inc(&c)
	assert.Equal(t, 3, Get(&c), "they should be equal")

	Inc(&c)
	assert.Equal(t, 4, Get(&c), "they should be equal")
...
func TestInt32(t *testing.T) {
	...
	Inc32(&c)
	assert.Equal(t, int32(3), Get32(&c), "they should be equal")

	Inc32(&c)
	assert.Equal(t, int32(4), Get32(&c), "they should be equal")
...
func TestInt64(t *testing.T) {
	...
	Inc64(&c)
	assert.Equal(t, int64(3), Get64(&c), "they should be equal")

	Inc64(&c)
	assert.Equal(t, int64(4), Get64(&c), "they should be equal")
